...
const DUMMY_EVENTS = [
  {
    ...
    description:
      'This is the event Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus consequuntur cupiditate, dolore earum eveniet,' +
...
const EventList = () => {
  ...
  const allEvents = DUMMY_EVENTS.filter((event) =>
    event.name.toLowerCase().startsWith(searchCtx.searchValue.toLowerCase())
  );
